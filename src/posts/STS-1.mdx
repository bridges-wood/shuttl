...
<Image
  src="/images/STS-1/STS-1_landing.jpeg"
  width={680}
  height={680}
...
### Launch
<Image
  src="/images/STS-1/STS-1_launch.jpeg"
  width={680}
  height={680}
...
> *Mission Control*: "Get to work, you guys. You've got three hundred government agencies out there to support. Now hear this, not hear this, reveille, reveille, up all idlers. And that last wakeup call, we'd like you to scrate out 'splashdown' and insert 'touchdown'."

This was then followed by a performance of Reveille by an unknown artist, constituing the last wakeup call for America's first shuttle mission.